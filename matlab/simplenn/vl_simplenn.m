...
for i=1:n
    ...
    switch l.type
        ...
        case 'maxout'
            [res(i+1).x, res(i+1).maxout] = vl_nnmaxout(res(i).x, 'maxout_groupsize', l.maxout_groupsize);
        case 'pdist'
...
if doder
    ...
    for i=n:-1:max(1, n-opts.backPropDepth+1)
        ...
        switch l.type
            ...
            case 'maxout'
                res(i).dzdx = vl_nnmaxout(res(i).x, res(i+1).dzdx, ...
                    'maxout_groupsize', l.maxout_groupsize, 'maxout_mask', res(i+1).maxout) ;
            case 'pdist'
